...
function canvasApp() {
	...
	function reduceSphereRad () {
		//debugger
		if (sphereRad <= 280) return;
		let reducedSphereRad = sphereRad * 0.8;
		sphereRad = reducedSphereRad > 280
			? reducedSphereRad
			: 280;
		/* window.requestAnimationFrame(reduceSphereRad); */
		window.setTimeout(reduceSphereRad,200)
	}
